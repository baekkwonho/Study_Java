...
##step07
- Exam082.java : 변수 사용 - 자바 기본 데이터 형
- Exam083.java : 변수 사용 - 정수 리터럴 값 저장
- Exam084.java : 변수 사용 - 정수 연산과 데이터 타입(연산의 최소단위는 int)
- Exam085.java : 변수 사용 - 다른 타입끼리의 연산 결과
- Exam086.java : 변수 사용 - 배열과 주소 변수(레퍼런스), 가비지와 가비지 컬렉터
- Exam087.java : 변수 사용 - 복합데이터 사용
...
- Exam141_*.java : Collection 클래스 (ArrayList, HashSet, HashMap, HashTable
