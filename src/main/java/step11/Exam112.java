...
public class Exam112 {
  ...
  static { // 클래스 로딩을 완료(스태틱 변수도 준비되었다)한 후 실행하라는 명령
    System.out.println("Exam112 로딩됨");
  }
  ...
  public static void main(String[] args) {
    ...
    Exam112 r1 = new Exam112(); // Exam041 클래스에 선언된 instance 변수를  Heap에 준비하라.
    Exam112 r2 = new Exam112();
    ...
    System.out.printf("Exam112.s1 = %d\n", Exam112.s1);
    System.out.printf("Exam112.s2 = %d\n", Exam112.s2);
